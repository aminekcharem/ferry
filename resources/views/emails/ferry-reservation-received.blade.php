    ...
    <div style="max-width:760px;margin:0 auto;">
        ...
        <div style="{{ $sectionStyle }}">
            ...
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                ...
                <tr><td style="{{ $labelStyle }}">Extra on roof</td><td style="{{ $valueStyle }}">{{ $yesNo((bool) $reservation->has_roof_extra) }}</td></tr>
                ...
                <tr><td style="{{ $labelStyle }}">Extra on back</td><td style="{{ $valueStyle }}">{{ $yesNo((bool) $reservation->has_back_extra) }}</td></tr>
