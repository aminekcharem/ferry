...
class StoreCtnReservationMessageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'roof_extra_height' => ['nullable', 'required_if:has_roof_extra,1', 'numeric', 'min:0', 'max:999999.99'],
            'has_back_extra' => ['nullable', 'boolean'],
            'back_extra_length' => ['nullable', 'required_if:has_back_extra,1', 'numeric', 'min:0', 'max:999999.99'],
