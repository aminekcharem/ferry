...
class StoreCtnReservationMessageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'has_roof_box' => ['nullable', 'boolean'],
            'has_roof_extra' => ['nullable', 'boolean'],
            'roof_extra_height' => ['nullable', 'required_if:has_roof_extra,1', 'in:0.50,1.00'],
            'roof_extra_outward' => ['nullable', 'boolean'],
            'has_back_extra' => ['nullable', 'boolean'],
            'back_extra_length' => ['nullable', 'required_if:has_back_extra,1', 'in:0.50,1.00'],
            'back_extra_outward' => ['nullable', 'boolean'],
            ...
            'trailer_type' => ['nullable', 'required_if:has_trailer,1', 'in:Trailer,Boat trailer,Caravan'],
